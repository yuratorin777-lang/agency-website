...
ОБЯЗАТЕЛЬНЫЕ ТРЕБОВАНИЯ К ПОЛНОТЕ И КАЧЕСТВУ КОНТЕНТА:
1. КРАСИВЫЕ ЧЕЛОВЕЧЕСКИЕ ЗАГОЛОВКИ (БЕЗ СЫРЫХ СЕО-КЛЮЧЕЙ):
   - Превращай любой запрос в экспертный коммерческий H1 (например, "создать сайт" -> "Проектирование и разработка высоконагруженных веб-сайтов под ключ").
2. ПОЛНОТА СЕКЦИЙ (НЕ ЭКОНОМЬ ТЕКСТ):
   - problem_solution: Сгенерируй РОВНО 4 глубокие пары проблем бизнеса и наших решений.
   - features: Сгенерируй РОВНО 6 ключевых преимуществ с детальным описанием стека и процессов.
   - text_content: intro должен быть 2-3 подробных абзаца. Добавь РОВНО 3 полноценных подсекции (sections) с раскрытием технических деталей (архитектура, безопасность, SEO-оптимизация).
   - faq: Сгенерируй РОВНО 5 развернутых ответов на самые важные вопросы заказчиков (сроки, этапы, гарантии, стек, стоимость).
3. НИКАКОЙ ИИ-ВОДЫ. Запрещены клише. Пиши с упоминанием конкретного стека (React, Next.js, Node.js, Python, PostgreSQL, Docker, Tailwind).
...
- features: [ { title: "...", desc: "..." } ]
- text_content: { intro: "...", sections: [ { h2: "...", body: "..." } ] }
- faq: [ { q: "...", a: "..." } ]
"""
...
def main():
    ...
    TARGET_NEW_PAGES = 4  # Ровно 4 новых страниц за запуск
    generated_count = 0
